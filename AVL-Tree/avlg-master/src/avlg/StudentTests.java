...
public class StudentTests {
    ...
    @Test 
    public void testBalanceHeight() throws InvalidBalanceException, EmptyTreeException { 
    	 tree = new AVLGTree<>(3);
         tree.insert(20);
         tree.insert(10);
         tree.insert(5);
    ...
    @Test 
    public void deleteAll() throws InvalidBalanceException, EmptyTreeException { 
    	tree = new AVLGTree<>(3);
        tree.insert(20);
        tree.insert(10);
        tree.insert(5);
    ...
    @Test
    public void twoInsertoneDelete() throws InvalidBalanceException, EmptyTreeException { 
    	tree = new AVLGTree<>(3); 
    ...
    @Test
    public void searching() throws EmptyTreeException, InvalidBalanceException { 
        ...
        assertEquals(null, tree.search(20));
